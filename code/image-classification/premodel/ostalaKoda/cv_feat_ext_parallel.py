...
if __name__ == "__main__":
    print(process_image((13513, '../val_1/ILSVRC2012_val_00013513.JPEG')))
    quit()
    ...
    features_list = process_image_parallel(image_paths_with_index, max_workers=12)  # Adjust max_workers as needed

    # Convert to DataFrame and save to CSV
    df = pd.DataFrame(features_list)
    df.to_csv('ilsvrc2012_features_50k.csv', index=False)